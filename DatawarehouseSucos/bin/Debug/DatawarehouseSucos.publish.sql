...
GO
PRINT N'Rename refactoring operation with key 9e4e7b8d-6e3b-48ab-9a5b-3c6baac3dbc6 is skipped, element [dbo].[dim_fabrica].[Id] (SqlSimpleColumn) will not be renamed to cod_fabrica';
